...
{
    public StandardGameAccount(decimal accountId, string userName, decimal currentRating) : base(accountId, userName,
        currentRating)
    {
    }
    ...
    {
        base.LoseGame(game);
        CurrentRating = ValidateRatingAfterLoss(game.CalculateRating());
    }
}